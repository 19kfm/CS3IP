      ...
      <div className="mx-auto max-w-6xl px-6 py-6 space-y-4">
        <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-3 text-sm text-gray-600">
            Review team-level wellbeing indicators based on anonymous peer feedback, average
            ratings, and repeated concern tags.
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {rows.map((r) => (
            ...
            >
              ...
              <div className="mt-4">
                ...
                {r.top_tags.length === 0 ? (
                  <p className="mt-1 text-sm text-gray-500">No concern tags have been submitted yet.</p>
                ) : (
          ...
          {!busy && rows.length === 0 && (
            <div className="rounded-2xl border border-dashed border-gray-200 bg-white p-8 text-sm text-gray-600">
              No team health data is available for this course yet. Indicators will appear once
              teams exist and students begin submitting feedback.
            </div>
          )}
        </div>

        <div className="text-sm text-gray-500">
          Team indicators become more meaningful as more feedback is submitted over time.
        </div>
      </div>
    </main>
  );
